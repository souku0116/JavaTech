    ...
    <div className="bg-white min-h-screen">
      <div className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-blue-300 font-semibold tracking-wider uppercase text-sm mb-4 block">Social Initiative</span>
          <h1 className="text-4xl md:text-6xl font-bold mb-8">Coding for Everyone</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            We partner with colleges, orphanages, and government institutions to provide free, high-quality technical training to deserving students who lack financial resources.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">We collaborate with educational institutions and NGOs to identify potential candidates.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Candidates undergo a screening process (Aptitude + Basic Logic) to ensure dedication and learning potential.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Selected students receive 3-6 months of intensive training in Java Development completely free of cost.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">We assist them in securing internships and full-time jobs with our hiring partners.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 p-8 rounded-2xl border border-gray-100">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <p className="text-sm text-slate-600 mb-4">Partner with us to bring this opportunity to your students.</p>
              <Link to="/contact" className="text-blue-600 font-semibold text-sm hover:underline">Contact our Partnership Team &rarr;</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
           ...
           <p className="text-lg text-slate-300 max-w-2xl mx-auto mb-10">
             If you represent a college, NGO, or government body and want to organize a campaign for your students, let's talk.
           </p>
           <Link to="/contact" className="bg-white text-slate-900 px-8 py-3 rounded-lg font-bold hover:bg-slate-100 transition-colors">
             Partner With Us
           </Link>
        </div>
      </div>
